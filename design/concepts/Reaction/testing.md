[@implementation](../Reaction/implementation.md)
...
# prompt: Property 'length' does not exist on type '{ reactions: ReactionDocument; }[] | { error: string; }'.  Property 'length' does not exist on type '{ error: string; }'
